...
function changePassword(){
    ...
    if(document.getElementById("RepeatNewPwd").value == document.getElementById("newPwd").value){
    ...
    socket.on("changePasswordReplay",function(data){
        if(data == "changed"){
            document.getElementById("changePasswordResponse").innerHTML = "Successfully changed password";
        }else{
            document.getElementById("changePasswordResponse").innerHTML = "Faild changed password";
        }
    });
...
socket.on('keyCheckReplay',function(data){
    ...
    document.getElementById("user").innerHTML = "<a style='color:#fff;' href='/account.html' >" + user.username + "</a>";
